...
# coding: utf-8
from libs import draw_seal as seal_base
from libs import draw_doublecircle_seal as seal_double_circle
from libs import seal_bg_generator as bg_generator
from libs.sp_utils import seal_util as drawer
...
def run(options):
    ...
    seal_gens[0].init_fonts(options.font_dir, options.font_chars)
...
def get_options(args=None):
    ...
    opt_parser.add_option('--config', type=str, default='/Volumes/work/personal/hanscal/ocr-recognition-datamaker/src/config/seal_config.yaml', help='define the content config file')
    opt_parser.add_option('--bg_dir', type=str, default='/Volumes/work/build-tools/all_bg/', help='define the background dir')
    opt_parser.add_option('--font_dir', type=str, default='/Volumes/work/build-tools/all_fonts/', help='define the fonts dir')
    opt_parser.add_option('--font_chars', type=str, default='/Volumes/work/build-tools/all_fonts/pt_fonts_char.json', help='define the fonts have chars')
