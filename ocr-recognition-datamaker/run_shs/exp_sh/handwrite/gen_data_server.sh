...
fonts_dir=/data/caihua/data/fonts/handwriting/ttf
out_root=/data/caihua/data/caihua/cn/handwrite
gen_number=600000

for i in {1..5};do
nohup python3 src/run.py --config run_shs/exp_sh/handwrite/config_server.yaml \
