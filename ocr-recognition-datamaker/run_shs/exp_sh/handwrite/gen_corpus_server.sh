...
# 可以添加多个corpus路径
existing_corpus_dir1=/data/caihua/data/wiki/cn
existing_corpus_dir2=$base_data_dir
generate_number_rand=1000
generate_number_semantic=3000000
...
echo $base_data_dir
sed -i "s#corpus_base_dir:.*#corpus_base_dir: $base_data_dir#" $ROOT_DIR/run_shs/exp_sh/idcard/config_server.yaml
...
echo "语义文本"
python3 src/corpus_generate_script/generate_semantic_sequence.py -n $generate_number_semantic -i $base_data_dir -o $output_dir/sementic_corpus_cn.txt
